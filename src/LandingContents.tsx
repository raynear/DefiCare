      ...
      <Grid container={true} className={classes.container}>
        ...
        <Grid item={true} className={classes.gridContents} xs={6} md={6} lg={6}>
          <Typography variant="body1" color="textPrimary">
            ...
            <br />
            NFT Chain 프로젝트는 퍼블릭 블록체인을 통해 다이아몬드 도매거래를 제공함으로써 투명성을 제공하여 이러한 국가정책에 부합하고 있습니다.
          </Typography>
        </Grid>
        <Grid item={true} className={classes.gridContents} xs={6} md={6} lg={6}>
        ...
        <Grid item={true} className={classes.gridContents} xs={12} md={12} lg={12}>
          <Typography variant="body1" color="textPrimary">
            NFT Chain 프로젝트는 우리나라 다이아몬드 시장의 관행이 상인들에게 매년 수천억원의 감내하기 힘든 신뢰비용을 지불하고 있다는 것을 발견했고 이 문제를 블록체인으로 풀어 내었습니다.<br /><br />
            De-Fi 개념을 적용해 투자를 통한 담보를 통해 신뢰문제를 풀어 내었고, 투자자들은 리스크를 감당하는 댓가로 거래 수수료를 수익으로 얻을 수 있습니다.<br />
            De-Fi를 산업에 적용함에는 유동성 문제가 반드시 따르게 됩니다. NFT Chain 프로젝트는 추후 소비자 개인이 소유한 잠자는 다이아몬드 및 귀금속을 통한 CDP 발행으로 유동성을 확보하는 방안을 고려하고 있습니다.
          </Typography>
        </Grid>
        <Grid item={true} className={classes.gridContents} xs={12} md={12} lg={12}>
          {" "}
