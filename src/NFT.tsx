...
import { poolContractAddress, poolABI, NFTContractAddress, NFTABI, Retailer } from "./SmartContract";
...
function NFT(props: any) {
  ...
  useEffect(() => {
    ...
    nftContract.methods.cards(props.match.params.ID).call().then((card: any) => {
      setValues({ clarity: card[0], cut: card[1], carat: "", color: "", price: 0, id: "", reportHash: "" });
    });
